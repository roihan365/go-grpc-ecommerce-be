...
type DetailProductResponse struct {
	...
	ImageFileName string                 `protobuf:"bytes,6,opt,name=image_file_name,json=imageFileName,proto3" json:"image_file_name,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DetailProductResponse) GetImageFileName() string {
	if x != nil {
		return x.ImageFileName
	}
	return ""
...
func (x *ListProductAdminResponseItem) GetImageFileName() string {
	if x != nil {
		return x.ImageFileName
	}
	return ""
...
type ListProductAdminResponse struct {
	state         protoimpl.MessageState          `protogen:"open.v1"`
	Base          *common.BaseResponse            `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"`
	Data          []*ListProductAdminResponseItem `protobuf:"bytes,2,rep,name=data,proto3" json:"data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_product_product_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xff\x01R\x02id\"\xc5\x01\n" +
	...
	"\x0fimage_file_name\x18\x06 \x01(\tR\rimageFileName\"\xd8\x01\n" +
	...
	"\x04base\x18\x01 \x01(\v2\x14.common.BaseResponseR\x04base\"\x19\n" +
	"\x17ListProductAdminRequest\"\xa2\x01\n" +
	"\x1cListProductAdminResponseItem\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\x14\n" +
	"\x05price\x18\x04 \x01(\x01R\x05price\x12&\n" +
	"\x0fimage_file_name\x18\x05 \x01(\tR\rimageFileName\"\x7f\n" +
	"\x18ListProductAdminResponse\x12(\n" +
	"\x04base\x18\x01 \x01(\v2\x14.common.BaseResponseR\x04base\x129\n" +
	"\x04data\x18\x02 \x03(\v2%.product.ListProductAdminResponseItemR\x04data2\xa3\x03\n" +
	...
	"\x10ListProductAdmin\x12 .product.ListProductAdminRequest\x1a!.product.ListProductAdminResponseB6Z4github.com/roihan365/go-grpc-ecommerce-be/pb/productb\x06proto3"
...
var file_product_product_proto_goTypes = []any{
	...
	(*ListProductAdminRequest)(nil),      // 8: product.ListProductAdminRequest
	(*ListProductAdminResponseItem)(nil), // 9: product.ListProductAdminResponseItem
	(*ListProductAdminResponse)(nil),     // 10: product.ListProductAdminResponse
...
var file_product_product_proto_depIdxs = []int32{
	...
	11, // 4: product.ListProductAdminResponse.base:type_name -> common.BaseResponse
	9,  // 5: product.ListProductAdminResponse.data:type_name -> product.ListProductAdminResponseItem
	0,  // 6: product.ProductService.CreateProduct:input_type -> product.CreateProductRequest
	2,  // 7: product.ProductService.DetailProduct:input_type -> product.DetailProductRequest
	4,  // 8: product.ProductService.EditProduct:input_type -> product.EditProductRequest
	6,  // 9: product.ProductService.DeleteProduct:input_type -> product.DeleteProductRequest
	8,  // 10: product.ProductService.ListProductAdmin:input_type -> product.ListProductAdminRequest
	1,  // 11: product.ProductService.CreateProduct:output_type -> product.CreateProductResponse
	3,  // 12: product.ProductService.DetailProduct:output_type -> product.DetailProductResponse
	...
	10, // 15: product.ProductService.ListProductAdmin:output_type -> product.ListProductAdminResponse
