...
const file_product_product_proto_rawDesc = "" +
	...
	"\x02id\x18\x02 \x01(\tR\x02id\"\xd8\x01\n" +
	...
	"\x04base\x18\x01 \x01(\v2\x14.common.BaseResponseR\x04base2\xfa\x01\n" +
	...
	"\rDeleteProduct\x12\x1d.product.DeleteProductRequest\x1a\x1e.product.DeleteProductResponseB6Z4github.com/roihan365/go-grpc-ecommerce-be/pb/productb\x06proto3"
...
var file_product_product_proto_goTypes = []any{
	...
	(*EditProductResponse)(nil),   // 3: product.EditProductResponse
...
var file_product_product_proto_depIdxs = []int32{
	...
	6, // 1: product.EditProductResponse.base:type_name -> common.BaseResponse
	6, // 2: product.DeleteProductResponse.base:type_name -> common.BaseResponse
	0, // 3: product.ProductService.CreateProduct:input_type -> product.CreateProductRequest
	2, // 4: product.ProductService.EditProduct:input_type -> product.EditProductRequest
	...
	3, // 7: product.ProductService.EditProduct:output_type -> product.EditProductResponse
